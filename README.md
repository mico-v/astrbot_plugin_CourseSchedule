...
当天的课程已经上完、当天没有课或被标记为休假的成员，会收纳到卡片下方的「今天已经没有课的群友」条带里，用小头像和昵称按网格排列（一行可显示多位），只在标题里报一次人数。所以一个大部分人都已下课的群，图片不会因为几十张「已结束」卡片而变得很长。只有查看**当天**时才收纳：查明天或过去某天仍然一人一张完整卡片，因为那时「距上课还有多久」正是要看的信息。
